...
export enum MLXModel {
  ...
  // Qwen 3.5 Small (Alibaba) - thinking off by default; opt in via enableThinking
  Qwen3_5_0_8B_4bit = 'mlx-community/Qwen3.5-0.8B-MLX-4bit',
  Qwen3_5_0_8B_8bit = 'mlx-community/Qwen3.5-0.8B-MLX-8bit',
  Qwen3_5_2B_4bit = 'mlx-community/Qwen3.5-2B-MLX-4bit',
  Qwen3_5_2B_8bit = 'mlx-community/Qwen3.5-2B-MLX-8bit',
...
export const MLXModels: ModelInfo[] = [
  ...
  {
    id: MLXModel.Qwen3_5_0_8B_4bit,
    family: ModelFamily.Qwen,
    provider: ModelProvider.Alibaba,
    parameters: '0.8B',
    quantization: '4bit',
    displayName: 'Qwen 3.5 0.8B (4-bit)',
    downloadSize: 625229487,
    type: 'llm',
  },
  {
    id: MLXModel.Qwen3_5_0_8B_8bit,
    family: ModelFamily.Qwen,
    provider: ModelProvider.Alibaba,
    parameters: '0.8B',
    quantization: '8bit',
    displayName: 'Qwen 3.5 0.8B (8-bit)',
    downloadSize: 1001176958,
    type: 'llm',
  },
  {
    id: MLXModel.Qwen3_5_2B_4bit,
    family: ModelFamily.Qwen,
    provider: ModelProvider.Alibaba,
    parameters: '2B',
    quantization: '4bit',
    displayName: 'Qwen 3.5 2B (4-bit)',
    downloadSize: 1722271785,
    type: 'llm',
  },
  {
    id: MLXModel.Qwen3_5_2B_8bit,
    family: ModelFamily.Qwen,
    provider: ModelProvider.Alibaba,
    parameters: '2B',
    quantization: '8bit',
    displayName: 'Qwen 3.5 2B (8-bit)',
    downloadSize: 2662910403,
    type: 'llm',
  },
  {
